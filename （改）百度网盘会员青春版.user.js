...
(function $baidu() {
	...
	*/
	...
	let info = {
		...
		version: (GM_info.script?.version || "1.2.7.1"),
	...
	temp.hooker.set(Function.prototype.toLocaleString);

	var originalAttachShadow = Element.prototype.attachShadow;
	unsafeWindow.Element.prototype.attachShadow = base.hooker.attachShadow;
	temp.hooker.set(Element.prototype.attachShadow);
